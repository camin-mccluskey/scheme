...
def scheme_read(src):
    ...
    if val == 'nil':
        ...
        # BEGIN PROBLEM 1
        # recursively call read_tail and return it's result
        # use src as first element (val) has already been removed
...
def read_tail(src):
    ...
    try:
        if src.current() is None:
            ...
            # BEGIN PROBLEM 1
            # return remove trailing parenthesis and return the nil object
            src.remove_front()
            return nil
            # END PROBLEM 1
        elif src.current() == '.':
            # BEGIN PROBLEM 2
            # check that closing parenthesis follows ONE additional element
            dot = src.remove_front()
            ...
            # BEGIN PROBLEM 1
            # else the current element is the start of a new expression
            # construct a pair class
