...
; tests for mu special form (Q16)

; tests for let special form (Q15)

; tests for cond special form (Q14)

; test for OR and AND logical operators (Q13)


; tests for lambda expressions (Q12)


;; test define statements (Q11)
(define x (+ 20 30))
; expect x
x
; expect 50
...
;test primitive procedure calls
(odd? 333)
; expect True
